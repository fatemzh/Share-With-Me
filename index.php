...
<body>
                            ...
                            <div id="home-left-part">
                                ...
                                <?php if ($isUserConnected === true) : ?>
                                    <div id="home-see-more">
                                        <a href="./src/pages/details.php?idBook=<?= $book["idBook"]; ?>">Voir plus</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div id="home-right-part">
                                <img src="./assets/img/covers/<?= $book['booImageURL'] ?>" alt="Couverture du livre <?= $book['booTitle'] ?>" id="home-cover-img">
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <main>
        ...
        <div id="home-introduction">
            ...
            <img id="home-introduction-img" src="./assets/img/covers/introduction.png" alt="Image représentant une paire de lunette sur un livre ouvert ">
        </div>
        ...
        <div id="home-latestReleases">
            ...
            <div id="home-latest-bookcard">
                <?php foreach ($newBooks as $book) : ?>
                    <?php include('./src/components/bookCard.php'); ?>
                <?php endforeach; ?>
            </div>
        </div>
            ...
            <div id="home-categories-name">
                <?php foreach ($categories as $category) : ?>
                    <div class="home-card-cat">
                        <a href="./src/pages/catalog.php?idCategory=<?= $category["idCategory"]; ?>" class="home-catalog-card"><?= $category["catName"]; ?></a>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
