...
// Récupère les donnnées, crée l'auteur s'il n'existe pas et ajoute un nouvel ouvrage dans la BD et affiche la page de catalogue principale, sinon retourne sur la page du formulaire d'ajout pour afficher les erreurs
