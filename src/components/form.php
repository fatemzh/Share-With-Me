<div id="book-form-container">
    <div id="form-left">
        ...
        <p class="space">
            ...
            <input type="file" id="excerptPDF" name="excerptPDF" value="Lien URL" accept="application/pdf" value="../../assets/pdf/excerptPDF/<?= $bookData["excerptName"]; ?>">
        </p>
    </div>
    <div id="form-right">
        ...
        <p class="space">
            ...
            <input type="file" id="coverImg" name="coverImg" accept="image/png, image/jpeg, img/jpg" value="../../assets/img/covers/<?= $bookData["coverName"]; ?>">
        </p>
    </div>
</div>