        ...
        <nav id="filter">
            ...
            <ul>
                ...
                <?php foreach ($allCategories as $category) : ?>
                    ...
                    <li><a <?php if (isset($_GET["idCategory"]) && $category["idCategory"] == $_GET["idCategory"]) : ?> class="active-category" <?php endif; ?> href="catalog.php?idCategory=<?= $category["idCategory"]; ?>"><?= $category["catName"]; ?></a></li>
                <?php endforeach; ?>
            </ul>
        </nav>
